...
public enum TypeID {
    UNKOWN(0, "未定义"),
    // region 1监视方向上的过程信息
    M_SP_NA_1(1, "单点信息", new ContentLayout[]{
            SIQ
    }),
    M_SP_TA_1(2, "带时标的单点信息", new ContentLayout[]{
            SIQ
    }, CP24Time2a),
    M_DP_NA_1(3, "双点信息", new ContentLayout[]{
            DIQ
    }),
    M_DP_TA_1(4, "带时标的双点信息", new ContentLayout[]{
            DIQ
    }, CP24Time2a),
    M_ST_NA_1(5, "步位置信息", new ContentLayout[]{
            VTI, QDS
    }),
    M_ST_TA_1(6, "带时标的步位置信息", new ContentLayout[]{
            VTI, QDS
    }, CP24Time2a),
    M_BO_NA_1(7, "32比特串", new ContentLayout[]{
            BSI, QDS
    }),
    M_BO_TA_1(8, "带时标的32比特串", new ContentLayout[]{
            BSI, QDS
    }, CP24Time2a),
    M_ME_NA_1(9, "测量值，规一化值", new ContentLayout[]{
            NVA, QDS
    }),
    M_ME_TA_1(10, "带时标的规一化值", new ContentLayout[]{
            NVA, QDS
    }, CP24Time2a),
    M_ME_NB_1(11, "测量值，标度化值", new ContentLayout[]{
            SVA, QDS
    }),
    M_ME_TB_1(12, "带时标的标度化值", new ContentLayout[]{
            SVA, QDS
    }, CP24Time2a),
    M_ME_NC_1(13, "测量值，短浮点数", new ContentLayout[]{
            IEEE_STD_754, QDS
    }),
    M_ME_TC_1(14, "带时标的短浮点数", new ContentLayout[]{
            IEEE_STD_754, QDS
    }, CP24Time2a),
    M_IT_NA_1(15, "累计量", new ContentLayout[]{
            BCR
    }),
    M_IT_TA_1(16, "带时标的累计量", new ContentLayout[]{
            BCR
    }, CP24Time2a),
    M_EP_TA_1(17, "带时标的继电保护设备事件", new ContentLayout[]{
            SEP, CP16Time2a
    }, CP24Time2a),
    M_EP_TB_1(18, "带时标的继电保护设备成组启动事件", new ContentLayout[]{
            SEP, QDP, CP16Time2a
    }, CP24Time2a),
    M_EP_TC_1(19, "带时标的继电保护设备成组输出电路信息", new ContentLayout[]{
            OCI, QDP, CP16Time2a
    }, CP24Time2a),
    M_PS_NA_1(20, "带状态检出的成组单点信息", new ContentLayout[]{
            SCD, QDS
    }),
    M_ME_ND_1(21, "不带品质描述的规一化测量值", new ContentLayout[]{
            NVA
    }),
    /* 22~29 为将来的兼容定义保留*/
    M_SP_TB_1(30, "带CP56Time2a时标的单点信息", new ContentLayout[]{
            SIQ
    }, CP56Time2a),
    M_DP_TB_1(31, "带CP56Time2a时标的双点信息", new ContentLayout[]{
            DIQ
    }, CP56Time2a),
    ...
    M_ME_TD_1(34, "带CP56Time2a时标的测量值，规一化值", new ContentLayout[]{
            NVA, QDS
    }, CP56Time2a),
    M_ME_TE_1(35, "带CP56Time2a时标的测量值，标度化值", new ContentLayout[]{
            SVA, QDS
    }, CP56Time2a),
    M_ME_TF_1(36, "带CP56Time2a时标的测量值，短浮点数", new ContentLayout[]{
            IEEE_STD_754, QDS
    }, CP56Time2a),
    M_IT_TB_1(37, "带CP56Time2a时标的累计量", new ContentLayout[]{
            BCR, QDS
    }, CP56Time2a),
    M_EP_TD_1(38, "带CP56Time2a时标的继电保护装置事件", new ContentLayout[]{
            SEP, CP16Time2a
    }, CP56Time2a),
    M_EP_TE_1(39, "带CP56Time2a时标的继电保护装置成组启动事件", new ContentLayout[]{
            SEP, QDP, CP16Time2a
    }, CP56Time2a),
    M_EP_TF_1(40, "带CP56Time2a时标的继电保护装置成组出口信息", new ContentLayout[]{
            OCI, QDP, CP16Time2a
    }, CP56Time2a),
    /* 41~44 为将来的兼容定义保留*/
    // endregion
    ...
    C_RC_NA_1(47, "调节步命令", new ContentLayout[]{
            RCO
    }),
    C_SE_NA_1(48, "设点命令，规一化值", new ContentLayout[]{
            NVA, QOS
    }),
    ...
    C_SE_TA_1(61, "带CP56Time2a时标的设点命令，规一化值", new ContentLayout[]{
            NVA, QOS
    }, CP56Time2a),
    ...
    C_CI_NA_1(101, "计数量召唤命令", new ContentLayout[]{
            QCC
    }),
    C_RD_NA_1(102, "读命令"),
    ...
    // endregion
    // region 5控制方向上的参数
    P_ME_NA_1(110, "测量值参数，规一化值", new ContentLayout[]{
            NVA, QPM
    }),
    ...
    F_LS_NA_1(123, "最后的节、段", new ContentLayout[]{
            NOF, NOS, LSQ, CHS
    }),
    F_AF_NA_1(124, "认可文件、节", new ContentLayout[]{
            NOF, NOS, AFQ, CHS
    }),
    F_SG_NA_1(125, "段", new ContentLayout[]{
            NOF, NOS, LOS //, segement
    }),
