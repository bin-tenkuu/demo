...
@EnableJpaRepositories(
        ...
        basePackages = "demo.auth.repository"
)
public class DataSourceSqlite {
    ...
    private Map<String, ?> buildJpaProperties(DataSource dataSource) {
        ...
        map.put(MappingSettings.PHYSICAL_NAMING_STRATEGY, PhysicalNamingStrategySnakeCaseImpl.class.getName());
