...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterAt(authenticationService, UsernamePasswordAuthenticationFilter.class);
        http.addFilterAt(authenticationService, UsernamePasswordAuthenticationFilter.class);
        http.exceptionHandling(config -> {
            config.authenticationEntryPoint(authenticationService);
            config.accessDeniedHandler(authenticationService);
        });
