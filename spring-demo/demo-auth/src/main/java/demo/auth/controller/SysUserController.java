...
import demo.auth.model.auth.SysUserAuthUpdate;
import demo.auth.model.auth.SysUserNewVo;
import demo.auth.model.auth.SysUserQuery;
...
import demo.auth.service.auth.TokenService;
...
public class SysUserController {
    ...
    public ResultModel<?> newSysUser(@RequestBody @Valid SysUserNewVo vo) {
        ...
        var sysUserAuth = new demo.auth.entity.SysUserAuth();
